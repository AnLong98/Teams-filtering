...
public class FileUtilitiesTests {
	...
	public void Test__getDataDictFromCSVFileLine__assert_content(){
		...
		String[] dataLine = {"110",	"Naletina",	"Nataša", "Female",	"1983",	"SRB",	"adidas runners beograd", "3:20:52"};
	...
	public void Test__getDataDictFromCSVFileLine__empty_field__assert_content(){
		...
		String[] dataLine = {"110",	"Naletina",	"Nataša", "Female",	"1983",	"SRB",	" ", "3:20:52"};
	...
	public void Test__ParseRunnerFromDataDict__assert_content(){
		...
		Runner expectedValue = new Runner("Nataša", "Naletina", "SRB", 110, 'F', LocalTime.of(3, 20, 52));
	...
	public void Test__ParseCSVFile__team_with_one_qualified_runner__assert_runner_info(){
		...
		Runner expectedRunner = new Runner("Predrag", "Glavaš", "SRB", 100, 'M', LocalTime.of(2, 20, 32));
